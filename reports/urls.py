...
urlpatterns = [
    ...
    path('general-entries/',  views.general_entries,  name='general_entries'),
    path('general-entries/<int:pk>/delete/', views.delete_journal_entry, name='delete_journal_entry'),
    path('journal-entries/',  views.operational_journal_entries, name='operational_journal_entries'),
